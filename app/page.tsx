...
const setupPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    featured: false,
    category: "setup",
    disclaimer: "*Setup included free with Professional or Advanced plans. Standalone setup available at $350."
  },
];
...
export default function Home() {
  ...
  return (
    <main style={{ fontFamily: "'Cabinet Grotesk', 'DM Sans', sans-serif", background: "#0A0A0A", color: "#F0EDE8" }} className="min-h-screen overflow-x-hidden">
      <style>{`
      ...
      <nav className="nav-glass sticky top-0 z-50">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <a href="#home" style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.25rem", fontWeight: 800, color: "var(--cream)", letterSpacing: "-0.01em" }}>
            Jawad Ahmed
          </a>

          <div className="hidden items-center gap-8 md:flex">
            {["Services", "Pricing", "Process", "About", "FAQ"].map((item) => (
              <a key={item} href={`#${item.toLowerCase()}`} className="nav-link">{item}</a>
            ))}
          </div>
          <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" className="btn-gold hidden rounded-xl px-5 py-2.5 text-sm md:inline-block">
            Free Audit →
          </a>

          <button type="button" onClick={() => setMobileOpen(!mobileOpen)} className="flex flex-col gap-1.5 p-2 md:hidden" aria-label="Toggle navigation menu">
            {[0, 1, 2].map((i) => (
              <span key={i} className="block h-px w-6 bg-[var(--cream)] transition-all duration-300"
                style={{
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div className="mob-menu mx-4 mb-3 overflow-hidden rounded-2xl"
              ...
              <div className="flex flex-col gap-1 p-4">
                ...
                <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" onClick={() => setMobileOpen(false)}
      ...
      <section id="home" className="relative min-h-[92vh] overflow-hidden flex items-center">
        ...
        <div className="pointer-events-none absolute inset-0" style={{ backgroundImage: "repeating-linear-gradient(90deg, rgba(240,237,232,0.025) 0px, rgba(240,237,232,0.025) 1px, transparent 1px, transparent 120px)", backgroundSize: "120px 100%" }} />
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <motion.div initial="hidden" animate="show"
              ...
              <motion.h1 className="hero-h1"
                ...
                Your ad data<br />
                <em style={{ color: "var(--gold)", fontStyle: "italic" }}>is lying</em><br />
                to you.
              </motion.h1>

              <motion.p className="mt-8 max-w-lg text-lg leading-8" style={{ color: "var(--cream-dim)" }}
                variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0, transition: { duration: 0.7, delay: 0.1 } } }}>
                Server-side tracking, Meta CAPI, offline conversions, GA4, and Google Ads setups that give your campaigns the accurate data they need to scale — not the misleading numbers they're getting now.
              </motion.p>

              <motion.div className="mt-10 flex flex-wrap gap-4"
                variants={{ hidden: { opacity: 0, y: 16 }, show: { opacity: 1, y: 0, transition: { duration: 0.6, delay: 0.2 } } }}>
                <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" className="btn-gold rounded-2xl px-8 py-4 text-base">
                  Book Free Audit
                </a>
              ...
              <motion.div className="mt-12 flex flex-wrap items-center gap-6"
                variants={{ hidden: { opacity: 0 }, show: { opacity: 1, transition: { duration: 0.6, delay: 0.35 } } }}>
                ...
                <div>
                  <div className="text-sm font-semibold" style={{ color: "var(--cream)" }}>100+ tracking setups delivered</div>
                  <div className="mt-0.5 text-xs" style={{ color: "var(--cream-dim)" }}>Trusted by marketers & agencies worldwide</div>
                </div>
              </motion.div>
            </motion.div>
            ...
            <motion.div
              ...
              <div style={{ position: "relative", width: "100%", maxWidth: 360, paddingTop: 24, paddingBottom: 24 }}>
                ...
                <motion.div
                  ...
                  <div style={{ fontSize: 9, letterSpacing: "0.14em", textTransform: "uppercase", fontFamily: "'DM Mono',monospace", color: "#B8B4AE", marginBottom: 4 }}>Meta EMQ Score</div>
                  <div style={{ fontFamily: "'DM Mono',monospace", fontSize: "1.7rem", fontWeight: 500, color: "#C9A84C", lineHeight: 1 }}>8.3</div>
                  <div style={{ fontSize: 10, color: "#4ade80", marginTop: 4, fontFamily: "'DM Mono',monospace" }}>↑ from 5.2 baseline</div>
                </motion.div>
                ...
                <motion.div
                  ...
                  <div style={{ fontSize: 9, letterSpacing: "0.14em", textTransform: "uppercase", fontFamily: "'DM Mono',monospace", color: "#B8B4AE", marginBottom: 4 }}>Conversions Recovered</div>
                  <div style={{ fontFamily: "'DM Mono',monospace", fontSize: "1.7rem", fontWeight: 500, color: "#C9A84C", lineHeight: 1 }}>+38%</div>
                  <div style={{ fontSize: 10, color: "#4ade80", marginTop: 4, fontFamily: "'DM Mono',monospace" }}>via server-side setup</div>
                </motion.div>
      ...
      <div style={{ borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", background: "var(--surface)", padding: "20px 0", overflow: "hidden" }}>
        <div className="marquee-inner logos-strip">
          {[...["gtm", "ga4", "meta", "google-ads", "stape", "gdpr", "calendly", "clarity", "cookiebot", "wordpress", "shopify"],
            ...["gtm", "ga4", "meta", "google-ads", "stape", "gdpr", "calendly", "clarity", "cookiebot", "wordpress", "shopify"]].map((logo, i) => (
      ...
      <motion.section style={{ background: "var(--surface)", borderBottom: "1px solid var(--border)" }}
        ...
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="grid grid-cols-2 gap-px md:grid-cols-4" style={{ background: "var(--border)" }}>
            {[
              ...
              <motion.div key={i} style={{ background: "var(--surface)", padding: "2.5rem 2rem" }}
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }} transition={{ delay: i * 0.1, duration: 0.6 }}>
                <div className="stat-big">{s.num}</div>
                <div className="mt-3 text-sm font-medium" style={{ color: "var(--cream)" }}>{s.label}</div>
                <div className="mt-1 text-xs" style={{ color: "var(--cream-dim)" }}>{s.sub}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <motion.section id="services" className="scroll-mt-24"
        style={{ background: "#0A0A0A" }}
        initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
        viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.6 }}>
        <div className="mx-auto max-w-7xl px-6 py-28">
          <motion.div className="mb-16 flex flex-col gap-5 md:flex-row md:items-end md:justify-between"
            ...
            <div>
              ...
              <h2 className="font-serif text-4xl font-bold leading-tight md:text-5xl" style={{ color: "var(--cream)" }}>
                Every layer of your<br />tracking stack,{" "}
          ...
          <div className="grid gap-px md:grid-cols-2 xl:grid-cols-3" style={{ background: "var(--border)" }}>
            {services.map((s, i) => (
              <motion.div key={i} className="svc-card p-7"
                initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                <h3 className="font-serif text-lg font-bold mb-3" style={{ color: "var(--cream)" }}>{s.title}</h3>
                <p className="text-sm leading-6" style={{ color: "var(--cream-dim)" }}>{s.desc}</p>
      ...
      <motion.section id="audit" className="scroll-mt-24" style={{ background: "var(--surface)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}
        initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="mx-auto max-w-7xl px-6 py-28">
          <div className="grid gap-16 md:grid-cols-2 md:items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
              ...
              <h2 className="font-serif text-4xl font-bold leading-tight md:text-5xl mb-6" style={{ color: "var(--cream)" }}>
                Find out exactly<br />
                <em style={{ color: "var(--gold)" }}>what you're missing.</em>
              </h2>
              <p className="text-base leading-8 mb-4" style={{ color: "var(--cream-dim)" }}>
                Before you invest in any setup, I'll review your current tracking and show you precisely what's broken, what's missing, and how much conversion data — including offline conversions — you're losing every day.
              </p>
              <p className="text-sm" style={{ color: "var(--cream-dim)", opacity: 0.6 }}>No pitch. No commitment. Just data.</p>
            </motion.div>

            <motion.div className="audit-card rounded-3xl p-8"
              initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.15 }}>
              <h3 className="font-serif text-xl font-bold mb-6" style={{ color: "var(--cream)" }}>What's covered in your free audit</h3>
              ...
              <div className="mb-6 rounded-2xl px-4 py-3.5 text-sm"
              ...
              <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" className="btn-gold block w-full rounded-2xl py-4 text-center text-base">
                Book Free Audit →
              </a>
            </motion.div>
          </div>
      ...
      <motion.section id="pricing" className="scroll-mt-24" style={{ background: "#0A0A0A" }}
        initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="mx-auto max-w-7xl px-6 py-28">
          <motion.div className="mb-16"
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-sm text-base leading-7" style={{ color: "var(--cream-dim)" }}>
                Fixed prices. You'll know the exact number before work begins — no hourly billing, no hidden costs.
              </p>
            </div>
          </motion.div>

          <motion.div className="mb-12 flex items-center justify-center gap-3"
          ...
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              className={`grid gap-5 ${pricingTab === "setup" ? "md:grid-cols-2 lg:grid-cols-4" : "md:grid-cols-3"}`}
            >
              {currentPlans.map((plan, i) => (
                <motion.div key={`${pricingTab}-${i}`}
                  className={`price-card flex flex-col rounded-3xl p-8 ${plan.featured ? "featured" : ""}`}
                  ...
                  <div className="flex items-start justify-between mb-6">
                    ...
                    {plan.featured && (
                      <motion.span 
                        ...
                        style={{ background: "rgba(201,168,76,0.15)", color: "var(--gold)", border: "1px solid rgba(201,168,76,0.3)", fontSize: 11, fontFamily: "'DM Mono',monospace", letterSpacing: "0.1em", textTransform: "uppercase", padding: "3px 10px", borderRadius: 99 }}
                      >
                        Best Value
                      </motion.span>
                    )}
                  ...
                  <h3 className="font-serif text-2xl font-bold mb-2" style={{ color: plan.featured ? "var(--gold-light)" : "var(--cream)" }}>{plan.title}</h3>

                  <div className="font-mono text-4xl font-medium mb-1" style={{ color: plan.featured ? "var(--gold)" : "var(--cream)" }}>{plan.price}</div>
                  <div className="text-xs mb-2 font-mono" style={{ color: "var(--cream-dim)" }}>{plan.sub}</div>

                  <div className="text-xs mb-5 px-3 py-1.5 rounded-lg self-start" style={{ background: "rgba(240,237,232,0.05)", color: "var(--cream-dim)", border: "1px solid var(--border)" }}>
                    Ideal for: {plan.ideal}
                  </div>

                  <p className="text-sm leading-6 mb-7" style={{ color: "var(--cream-dim)" }}>{plan.desc}</p>
                  ...
                  {plan.addons && (
                    <div className="mb-6 space-y-2">
                      <div className="text-xs font-mono uppercase tracking-wider mb-3" style={{ color: "var(--gold)", opacity: 0.8 }}>Optional Add-ons:</div>
                      {plan.addons.map((addon, k) => (
                        <div key={k} className="addon-item">{addon}</div>
                      ))}
                    </div>
                  )}

                  {plan.disclaimer && (
                    <div className="mb-6 text-xs leading-5 px-3 py-2 rounded-lg" style={{ background: "rgba(201,168,76,0.05)", color: "var(--cream-dim)", border: "1px solid rgba(201,168,76,0.15)" }}>
                      {plan.disclaimer}
                    </div>
                  )}

                  <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer"
                    className={`block w-full rounded-2xl py-4 text-center text-sm font-bold transition ${plan.featured ? "btn-gold" : "btn-outline"}`}>
                    {plan.cta} →
                  </a>
                </motion.div>
              ))}
          ...
          >
            ...
            <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" style={{ color: "var(--gold)", textDecoration: "underline", textUnderlineOffset: 3 }}>Start with a free audit.</a>
          </motion.p>
        </div>
      </motion.section>

      <motion.section id="process" className="scroll-mt-24"
        ...
        <div className="mx-auto max-w-7xl px-6 py-28">
          <motion.div className="mb-16"
            ...
            <h2 className="font-serif text-4xl font-bold md:text-5xl" style={{ color: "var(--cream)" }}>
          ...
          <div className="grid gap-px md:grid-cols-4" style={{ background: "var(--border)" }}>
            {process.map((step, i) => (
              <motion.div key={i} style={{ background: "var(--surface)", padding: "2.5rem 2rem" }}
                ...
                <h3 className="font-serif text-xl font-bold mb-4" style={{ color: "var(--cream)" }}>{step.title}</h3>
                <p className="text-sm leading-7" style={{ color: "var(--cream-dim)" }}>{step.desc}</p>
                <div className="mt-8 h-px w-12 transition-all duration-500 group-hover:w-24"
      ...
      <motion.section id="about" className="scroll-mt-24" style={{ background: "#0A0A0A" }}
        initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.1 }} transition={{ duration: 0.7 }}>
        <div className="mx-auto max-w-7xl px-6 py-28">
          <div className="grid gap-16 md:grid-cols-2 md:items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <div className="relative">
                <div className="overflow-hidden rounded-3xl" style={{ border: "1px solid var(--border)" }}>
                  <img src="/jawad-profile.png" alt="Jawad Ahmed" className="h-full w-full object-cover" style={{ display: "block" }} />
                </div>
                <div className="absolute -bottom-4 -right-4 h-32 w-32 rounded-2xl"
                  style={{ border: "1px solid rgba(201,168,76,0.25)", background: "transparent", zIndex: -1 }} />
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.1 }}>
              ...
              <h2 className="font-serif text-4xl font-bold leading-tight mb-6" style={{ color: "var(--cream)" }}>
                I speak both<br />
                <em style={{ color: "var(--gold)" }}>marketing and data.</em>
              </h2>
              <p className="text-base leading-8 mb-5" style={{ color: "var(--cream-dim)" }}>
                Most tracking specialists are either technical or marketing-focused. I bridge both. I understand what campaign managers need — ROAS clarity, clean attribution, lower CPAs — and I know exactly how to configure the infrastructure to make those numbers trustworthy.
              </p>
              <p className="text-base leading-8 mb-8" style={{ color: "var(--cream-dim)" }}>
                I've built tracking systems for eCommerce brands, SaaS companies, lead-gen agencies, and service businesses. Specialties include server-side tagging, offline conversion imports, and closing the gap between ad spend and actual revenue — not just form fills.
              </p>
              <div className="flex flex-wrap gap-2">
                {["GTM", "sGTM", "GA4", "Meta CAPI", "Google Ads", "Offline Conversions", "Consent Mode v2", "Stape.io", "Clarity", "Shopify", "WooCommerce", "Cookiebot"].map((tag) => (
      ...
      <motion.section id="faq" className="scroll-mt-24"
        ...
        <div className="mx-auto max-w-5xl px-6 py-28">
          <motion.div className="mb-16 text-center"
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <div style={{ width: 40, height: 2, background: "linear-gradient(270deg, var(--gold), transparent)" }} />
            </div>
            <h2 className="font-serif text-4xl font-bold md:text-5xl" style={{ color: "var(--cream)" }}>
          ...
          <div className="rounded-3xl overflow-hidden" style={{ border: "1px solid var(--border)", background: "var(--surface-2)" }}>
            {faqs.map((faq, i) => (
              <motion.div key={i} className="faq-row"
                ...
                <button
                  ...
                  <span className="font-serif pr-8 text-base font-bold" style={{ color: "var(--cream)" }}>{faq.q}</span>
                  <motion.span 
                ...
                <AnimatePresence>
                  {openFaq === i && (
                    <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }}
                      ...
                      <div className="px-8 pb-6 text-sm leading-7" style={{ color: "var(--cream-dim)" }}>{faq.a}</div>
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
      ...
      <motion.section id="contact" className="contact-section scroll-mt-24"
        initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.05 }} transition={{ duration: 0.7 }}>
        <div className="mx-auto max-w-7xl px-6 py-28">
          <motion.div className="mx-auto max-w-3xl text-center"
            ...
            <motion.h2 variants={{ hidden: { opacity: 0, y: 30 }, show: { opacity: 1, y: 0, transition: { duration: 0.8 } } }}
              className="font-serif mb-6" style={{ fontSize: "clamp(2.8rem, 6vw, 5.5rem)", fontWeight: 900, color: "var(--cream)", lineHeight: 1.05, letterSpacing: "-0.02em" }}>
              Let's fix your<br />
              <em style={{ color: "var(--gold)" }}>tracking.</em>
            </motion.h2>

            <motion.p variants={{ hidden: { opacity: 0, y: 16 }, show: { opacity: 1, y: 0 } }}
              className="mb-10 text-lg leading-8" style={{ color: "var(--cream-dim)" }}>
              Book a free 30-minute audit call. I'll review your setup live — including offline conversion gaps — show you what's broken, and tell you exactly what it would take to fix it. Zero sales pressure.
            </motion.p>
            ...
            <motion.div variants={{ hidden: { opacity: 0, y: 16 }, show: { opacity: 1, y: 0 } }}
              ...
              <a href={EMAIL_LINK}
                ...
                <img src="/gmail.png" alt="Gmail" className="h-5 w-5 object-contain" />
                Email Me
              </a>
            ...
            <motion.div variants={{ hidden: { opacity: 0 }, show: { opacity: 1 } }}
              ...
              {["Fast Turnaround", "End-to-End Setup", "14-Day Post-Launch Support", "GDPR Compliant"].map((item) => (
                <div key={item} className="flex items-center gap-2 text-sm" style={{ color: "var(--cream-dim)" }}>
          ...
          <div className="mt-20 flex flex-col items-center justify-between gap-4 md:flex-row"
            style={{ borderTop: "1px solid var(--border)", paddingTop: "2rem" }}>
            <span className="font-mono text-xs" style={{ color: "var(--cream-dim)", opacity: 0.5 }}>
      ...
      <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
        className="wa-float fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-2xl px-4 py-3">
        ...
        <span className="text-sm font-medium" style={{ color: "var(--cream)" }}>Available · Chat</span>
        <img src="/jawad-profile.png" alt="Jawad Ahmed"
